...
func GetLastEventID() {
	...
	conn, response, err := websocket.DefaultDialer.DialContext(ctx, "wss://report-worker-ng.noscription.org/", PublicHeaders)
	if err != nil {
